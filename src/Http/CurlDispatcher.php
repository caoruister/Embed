...
class CurlDispatcher implements DispatcherInterface
{
    ...
    private $config = [
        ...
        CURLOPT_USERAGENT => 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/83.0.4103.14 Mobile/15E148 Safari/604.1',
